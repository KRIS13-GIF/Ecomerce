...
const NewAdmin = () => {
    ...
    useEffect(() => {
        ...
        if (auth) { navigate('/admin') } // if you are logged in, you can not go to the sign up section because it is useless
    ...
    const collectData = async () => {
        ...
        let result = await fetch(" http://localhost:5000/new-admin", {
            method: 'post',
        ...
        navigate('/admin'); // you redirected to the welcome page after you sign up (click)
    }
